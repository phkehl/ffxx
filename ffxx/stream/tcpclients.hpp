...
{
   public:
    StreamTcpClientsBase(const StreamOptsTcpClientsBase& opts_init);
   ...
   protected:
    const StreamOptsTcpClientsBase* bb_opts_ = nullptr;  // Stream options, see base.cpp for explanation
