...
configuid=$(shell echo "$(BUILD_TYPE) $(BUILD_FFGUI) $(INSTALL_PREFIX) $(BUILD_TESTING) $(FF_VERSION_STRING) $(CC) $(CXX) $$(uname -a)" | md5sum | cut -d " " -f1)

.PHONY: help
help:
	@echo "Usage:"
	@echo
	@echo "    make <target> [INSTALL_PREFIX=...] [BUILD_TYPE=Debug|Release] [BUILD_TESTING=|ON|OFF] [BUILD_FFGUI=OFF|ON] [FF_VERSION_STRING=x.x.x-gggggggg] [VERBOSE=1]"
	@echo
...
#	@echo "    doc-dev             Generate documentation and start webserver to view it"
	...
	@echo
	@echo "     make install INSTALL_PREFIX=~/ffgui"
	@echo
	@echo "Notes:"
	@echo
...
CMAKE_ARGS := -DCMAKE_INSTALL_PREFIX=$(INSTALL_PREFIX) -DBUILD_FFGUI=$(BUILD_FFGUI)
...
deps_build = $(sort $(wildcard ubloxcfg/* cfgtool/* \
	ffxx/* ffxx/*/* ffxx/*/*/* ffapps/* ffapps/*/* ffapps/*/*/* ffgui/* ffgui/*/* ffgui/*/*/* ffgui/*/*/*/* \
	3rdparty/* 3rdparty/ubloxcfg/*/* 3rdparty/imgui/* 3rdparty/implot/* \
	3rdparty/fixposition-sdk/* 3rdparty/fixposition-sdk/*/* 3rdparty/fixposition-sdk/*/*/* 3rdparty/fixposition-sdk/*/*/*/* 3rdparty/fixposition-sdk/*/*/*/*/* ))
