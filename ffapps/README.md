...
This contains various apps:

- streammux: stream multiplexer for GNSS receivers and similar devices
- streamtool: stream tool for GNSS receivers and similar devices

## Build and install

(Consider using the top-level CMakeList.txt or Makefile to easily build these apps.
