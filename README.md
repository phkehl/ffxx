...
apt install libcurl4-gnutls-dev libglfw3-dev libfreetype-dev zlib1g-dev libglm-dev libeigen3-dev libgl-dev \
    ...
    gcc g++ cmake make xxd nlohmann-json3-dev libxrandr-dev libwayland-dev libmime-base64-perl libpath-tiny-perl \
    libdata-float-perl libbacktrace-dev
...
echo -e "BUILD_TYPE=Debug\nBUILD_FFGUI=OFF" > config.mk

make build

./build/Debug/ffapps/streamtool
./build/Debug/ffapps/parserdump
./build/Debug/ffapps/streammux
./build/Debug/ffgui/ffgui
./build/Debug/cfgtool/cfgtool
./build/Debug/fpsdk_apps/timeconv
./build/Debug/fpsdk_apps/parsertool
```
