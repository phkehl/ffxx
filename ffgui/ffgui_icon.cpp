...
const GLFWimage *appIcon()
{
    // ffgui/appicon.png -> https://convertio.co/png-rgba/ -> xxd -i
    static const uint8_t icon[] = // clang-format off
    {
    ...
    static const GLFWimage image = { .width = 32, .height = 32, .pixels = (unsigned char*)icon };
    return &image;
}
