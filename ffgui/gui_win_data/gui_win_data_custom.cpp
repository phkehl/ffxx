...
void GuiWinDataCustom::_ProcessData(const InputDataPtr& /*data*/)
{
}
...
{
    if (tabbar_.Begin()) {
        const auto tbHex_  = tabbar_.Item("Hex");  doHex_  = tbHex_ .isSelected_; if (tbHex_ .newlySelected_) { dirty_ = true; }
        const auto tbText_ = tabbar_.Item("Text"); doText_ = tbText_.isSelected_; if (tbText_.newlySelected_) { dirty_ = true; }
        const auto tbUbx_  = tabbar_.Item("UBX");  doUbx_  = tbUbx_ .isSelected_; if (tbUbx_ .newlySelected_) { dirty_ = true; }
        const auto tbNmea_ = tabbar_.Item("NMEA"); doNmea_ = tbNmea_.isSelected_; if (tbNmea_.newlySelected_) { dirty_ = true; }
        tabbar_.End();
    }
