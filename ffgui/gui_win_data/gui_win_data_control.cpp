...
void GuiWinDataControl::_ProcessData(const InputDataPtr& /*data*/)
{
...
{
    if (tabbar_.Begin()) {
        tabbar_.Item("u-blox",       [this](const GuiWidgetTabbar::State&) { _DrawUblox(); });
        tabbar_.Item("Fixposition",  [this](const GuiWidgetTabbar::State&) { _DrawFixposition(); });
        tabbar_.Item("Quectel",      [this](const GuiWidgetTabbar::State&) { _DrawQuectel(); });
#ifndef NDEBUG
        tabbar_.Item("Debug",        [this](const GuiWidgetTabbar::State&) {
