    ...
    input_   { input }  // clang-format on
{
    ...
    input_->AddObserver(this, std::bind(&GuiWinData::_ProcessInputDataMain, this, std::placeholders::_1));
}
...
void GuiWinData::_ProcessInputDataMain(const InputDataPtr& data)
{
