...
GuiWinExperiment::GuiWinExperiment() /* clang-format off */ :
    ...
    saveFileDialog_   { WinName() + ".SaveFileDialog" }  // clang-format on
{
}
...
void GuiWinExperiment::DrawWindow()
{
    ...
    if (tabbar_.Begin()) {
        tabbar_.Item("GuiWinFileDialog", [this](const GuiWidgetTabbar::State&) { _DrawGuiWinFileDialog(); });
        tabbar_.Item("GuiNotify",        [this](const GuiWidgetTabbar::State&) { _DrawGuiNotify();        });
        tabbar_.Item("GuiWidgetMap",     [this](const GuiWidgetTabbar::State&) { _DrawGuiWidgetMap();     });
        tabbar_.Item("Matrix",           [this](const GuiWidgetTabbar::State&) { _DrawMatrix();           });
        tabbar_.Item("Icons",            [this](const GuiWidgetTabbar::State&) { _DrawIcons();            });
        tabbar_.Item("Allecheibs",       [this](const GuiWidgetTabbar::State&) { _DrawAllecheibs();       });
        tabbar_.End();
    }
...
void GuiWinExperiment::_DrawAllecheibs()
{
    if (ImGui::Button("Throw up")) {
        throw "uuups";
    }
