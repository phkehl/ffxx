...
void GuiWinAppAbout::DrawWindow()
{
    ...
    _DrawEntry("ImGuiColorTextEdit",          "MIT license",          "https://github.com/goossens/ImGuiColorTextEdit");
...
void GuiWinAppSettings::DrawWindow()
{
    ...
    if (tabbar_.Begin()) {
        if (tabbar_.Item("Font").isSelected_) { GuiGlobal::DrawSettingsEditorFont(); }
        if (tabbar_.Item("Colours").isSelected_) { GuiGlobal::DrawSettingsEditorColours(); }
        if (tabbar_.Item("Maps").isSelected_) { GuiGlobal::DrawSettingsEditorMaps(); }
        if (tabbar_.Item("Misc").isSelected_) { GuiGlobal::DrawSettingsEditorMisc(); }
        if (tabbar_.Item("Tools").isSelected_) { GuiGlobal::DrawSettingsEditorTools(); }
        tabbar_.End();
    }
...
void GuiWinAppHelp::DrawWindow()
{
    ...
    if (tabbar_.Begin()) {
        if (tabbar_.Item("Help").isSelected_) {
            ...
            ImGui::BulletText("Right click title bar for window actions\n"
                              "(and note the keyboard shortcuts affecting a focused window)");
...
void GuiWinAppLegend::DrawWindow()
{
    ...
    if (tabbar_.Begin()) {
        if (tabbar_.Item("Fix colours").isSelected_) {
            doFixColours = true;
        }
        if (tabbar_.Item("Signal levels").isSelected_) {
            doSignalLevels = true;
        }
        if (tabbar_.Item("Messages").isSelected_) {
            doMessages = true;
        }
        tabbar_.End();
    }
