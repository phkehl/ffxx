...
#ifndef __GUI_GLOBAL_COLOURS_HPP__
#define __GUI_GLOBAL_COLOURS_HPP__

namespace ffgui {
/* ****************************************************************************************************************** */

// clang-format off
#define GUI_GLOBAL_COLOURS(_P_) \
    ...
    _P_("Text highlight fg",     TEXT_HIGHLIGHT_FG,            IM_COL32(0xff, 0xa2, 0x57, 0xff)) \
    _P_("Text highlight bg",     TEXT_HIGHLIGHT_BG,            IM_COL32(0xff, 0xff, 0x55, 0x33)) \
    ...
    _P_("Signal used (text)",    SIGNAL_USED_TEXT,             IM_COL32(0xaf, 0xff, 0xaf, 0xff)) \
    ...
    _P_("Colour Transparent",    C_TRANSPARENT,                IM_COL32(0x00, 0x00, 0x00, 0x00)) \
    /* Log window */ \
    _P_("Log UBX messages",      LOG_MSG_UBX,                  IM_COL32(0xff, 0x75, 0x75, 0xff)) \
    _P_("Log NMEA messages",     LOG_MSG_NMEA,                 IM_COL32(0x7f, 0xbf, 0x71, 0xff)) \
    _P_("Log FP_A messages",     LOG_MSG_FP_A,                 IM_COL32(0xff, 0x81, 0x40, 0xff)) \
    _P_("Log FP_B messages",     LOG_MSG_FP_B,                 IM_COL32(0xff, 0x81, 0x40, 0xff)) \
    _P_("Log RTCM3 messages",    LOG_MSG_RTCM3,                IM_COL32(0x94, 0x58, 0xfb, 0xff)) \
    _P_("Log NOV_B messages",    LOG_MSG_NOV_B,                IM_COL32(0x40, 0x8a, 0xff, 0xff)) \
    _P_("Log UNI_B messages",    LOG_MSG_UNI_B,                IM_COL32(0x40, 0x8a, 0xff, 0xff)) \
    _P_("Log SBF messages",      LOG_MSG_SBF,                  IM_COL32(0x40, 0x8a, 0xff, 0xff)) \
    _P_("Log QGC messages",      LOG_MSG_QGC,                  IM_COL32(0x40, 0x8a, 0xff, 0xff)) \
    _P_("Log SPARTN messages",   LOG_MSG_SPARTN,               IM_COL32(0xff, 0x40, 0xfe, 0xff)) \
    _P_("Log OTHER messages",    LOG_MSG_OTHER,                IM_COL32(0xbe, 0xe5, 0xfe, 0xff)) \
    _P_("Log Epochs",            LOG_EPOCH,                    IM_COL32(0xff, 0xfd, 0x40, 0xff)) \
    /* Debug logs */ \
    _P_("Debug Trace",           DEBUG_TRACE,                  IM_COL32(0xaa, 0x00, 0xaa, 0xff)) \
    _P_("Debug Debug",           DEBUG_DEBUG,                  IM_COL32(0x00, 0xaa, 0xaa, 0xff)) \
    _P_("Debug Info",            DEBUG_INFO,                   IM_COL32(0xaa, 0xaa, 0xaa, 0xff)) \
    ...
    _P_("Debug Fatal",           DEBUG_FATAL,                  IM_COL32(0xff, 0x55, 0x55, 0xff)) \
    /* end of list */

// clang-format on
/* ****************************************************************************************************************** */
}  // namespace ffgui
#endif  // __GUI_GLOBAL_COLOURS_HPP__
