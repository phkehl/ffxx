...
- *ImGuiColorTextEdit* (<https://github.com/goossens/ImGuiColorTextEdit>), see [3rdparty/texteditor/](./3rdparty/texteditor/)
...
- Handle database reset (insert blank epoch?) when seeking in logfile. Is it still a problem?
