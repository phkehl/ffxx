...
class GuiWinInput : public GuiWin
{
   ...
   protected:
    InputPtr input_;
    GuiWidgetLog log_;
    InputDataEpochPtr latestEpoch_;
    Duration latestEpochMaxAge_; // set to zero to disable latestEpoch
    InputDataEpochPtr latestEpochWithSigCnoHist_;
   ...
   private:
    ...
    virtual void _ProcessData(const InputDataPtr& data);  // noop due to crash when this is pure virtual
    ...
    void _ProcessInputDataMain(const InputDataPtr& data);
};
