...
GuiWinInputReceiver::GuiWinInputReceiver(const std::string& name) /* clang-format off */ :
    GuiWinInput(name, { 90, 25, 0, 0 }, ImGuiWindowFlags_None, Input::Create(name, InputType_Receiver)),
...
void GuiWinInputReceiver::_ProcessData(const InputDataPtr& data)
{
